The objective of this project is to build a complete and reusable framework for Orthogonal Persistence (Atkinson & Morrison, 1995) in concurrent environments with support for transactions.
